          ...
          <div class="card-body p-10 text-center" style="height: 400px; align-self: center">
            ...
            <div class="mb-md-5 mt-md-8 pb-6" >
              ...
              <div class="form-outline form-dark mb-4">
                <input type="text" required autofocus id="nombre_usuario" style="width: 250px" name = "nombre_usuario" class="form-control form-control-md" value="{{old('nombre_usuario')}}">
                <label class="form-label" for="nombre_usuario">Nombre de usuario</label>
              </div>

              <div class="form-outline form-dark mb-4">
                <input type="password" required  aria-invalid="false" autofocus id="contrasena"  style="width: 250px" name = "contrasena" class="form-control form-control-md">
