<!-- Modal -->
<div class="modal fade" id="proveedorDelete{{$proveedor->id_proveedor}}" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="upDeleteLabel" aria-hidden="true">
            ...
            <div class="content" style="align-self: center">
                <div class="modal-body bg-white">
                        <div class = "row">
                            ...
                            <br>
                         <h5 style="color: dark; text-align: center;">¿Está seguro de eliminar {{$proveedor->id_proveedor}}?</h5>                    
                </div>
            </div>
